  ...
  <div class="cart-container" style="min-height: 70vh;">
    <div class="cart-empty">
      ...
      <div class="btn-continue-wrapper text-center">
        ...
        <a href="index.php">
          <button type="button" class="btn" style="font-size: 0.9rem;">Continue shopping</button>
        </a>
    ...
    <div class="cart-available">
      ...
      <div class="row">
        ...
        <div class="summary-wrapper col-md-3">
          ...
          <a href="payment.php">
            <button type="button" class="btn btn-danger w-100 mt-3 check-out-btn">Checkout</button>
          </a>
        </div>
      </div>
