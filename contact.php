...
<div class="container mt-3">
  ...
  <div class="row">
      ...
      <form action="" method="POST" class="submit-form">
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control rounded-form" id="validationDefault01" placeholder="First name"
              required>
          </div>
          <div class="form-group col-md-6">
            <label for="validationDefault02" class="rounded-pill px-2 font-weight-bold">Phone</label>
            <input type="text" class="form-control rounded-form" id="validationDefault02" placeholder="Phone"
              required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control rounded-form" placeholder="Leave a message here"
    ...
    <div class="col-lg-6 px-0 mt-4">
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.6307732935124!2d106.67998301532461!3d10.762912992330776!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f1c06f4e1dd%3A0x43900f1d4539a3d!2sVietnam%20National%20University%20Ho%20Chi%20Minh%20City%20-%20University%20of%20Science!5e0!3m2!1sen!2s!4v1616227684239!5m2!1sen!2s"
        width="600" height="288" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
      ...
      <p>
        ...
        Website: <a href="index.php">www.technow.vn</a>
      </p>
    </div> <!-- end of col-md-6 -->
  </div> <!-- end of row -->
